  ...
  return (
    <div className="w-full h-screen">
      <form class="flex items-center lg:max-w-4xl md:max-w-2xl max-w-sm mx-auto my-10">
        ...
        <button
          type="submit"
          class="p-2.5 ms-2 text-sm font-medium text-white bg-green-500 rounded-lg border hover:bg-transparent hover:text-black dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
        >
          <svg
            class="w-5 h-5 md:w-6 md:h-6 lg:w-8 lg:h-8"
            aria-hidden="true"
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 20 20"
